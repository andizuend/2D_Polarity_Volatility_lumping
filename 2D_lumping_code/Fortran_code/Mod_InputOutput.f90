...
!============================================================================================
    ...
    !*                                                                                      *
    !****************************************************************************************
    subroutine Output_TXT(fname, version_AIOMFAC, nspecmax, npoints, watercompno, cpnameinp, T_K, &
    ...
    character(len=*),intent(in) :: version_AIOMFAC
    ...
    write(unitx,'(A)') "==========================================================================================================="
    write(unitx,'(A)') "AIOMFAC-web, version "//version_AIOMFAC
    write(unitx,'(A)') "==========================================================================================================="
    write(unitx,*) ""
    ...
    !*                                                                                      *
    !****************************************************************************************
    subroutine Output_HTML(fname, version_AIOMFAC, nspecmax, npoints, watercompno, cpnameinp, T_K, &
        & px, out_data, out_viscdata)
    ...
    !--
    open (NEWUNIT = unitx, FILE = fname, STATUS = "UNKNOWN")
    outtxtleft = adjustl("<h3>AIOMFAC-web, version "//version_AIOMFAC//"</h3>")
